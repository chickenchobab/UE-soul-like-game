...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FWaitSpawnEnemiesDelegate, const TArray<ASoulEnemyCharacter*>&, SpawnedEnemies);

/**
 * 
 */
UCLASS()
class SOULLIKEGAME_API UAbilityTask_WaitSpawnEnemies : public UAbilityTask
{
	GENERATED_BODY()
...
private:
	...
	TSoftClassPtr<ASoulEnemyCharacter> CachedSoftEnemyClassToSpawn;
